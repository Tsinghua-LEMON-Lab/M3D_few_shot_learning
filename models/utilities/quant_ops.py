...
from models.utilities.common import mapping_2t2r, get_pulse
...
class QuantConv2d(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
                 padding=1, dilation=1, groups=1, bias=False, weight_k_bits=4, feature_k_bits=8, noise=False, noise_type=None):
    ...
    def forward(self, x, order=None):
        weight_q = self.QuantWeight(self.weight)
...
class QuantLinear(nn.Module):
    ...
    """
    def __init__(self, in_channels, out_channels, bias=True, noise=False, noise_type=None):
